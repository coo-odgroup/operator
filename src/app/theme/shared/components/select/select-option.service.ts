...
import {} from 'ng-select';

@Injectable()
export class SelectOptionService {
  public static readonly PLAYER_ONE: Array<> = [
  ...
  private static readonly COUNTRIES: Array<> = [
  ...
  public cloneOptions(options: Array<>): Array<> {
    ...
    loadCharacters(): Observable<Array<>> {
        return this.loadOptions(SelectOptionService.PLAYER_ONE);
    }

    getCharactersWithDisabled(): Array<> {
        const characters: Array<> = this.cloneOptions(SelectOptionService.PLAYER_ONE);
    ...
    loadCountries(): Observable<Array<>> {
        return this.loadOptions(SelectOptionService.COUNTRIES);
    }

    private loadOptions(options: Array<>): Observable<Array<>> {
