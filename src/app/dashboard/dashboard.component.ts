...
export class DashboardComponent implements OnInit {
  ...
  pieChart() {
    this.pie2CAC = {
      ...
      series: [
        this.dashboarddata.mobile_booking.length,
        this.dashboarddata.web_booking.length,
        this.dashboarddata.app_booking.length,
      ],
  ...
  toproute() {
    ...
    this.ds.toproute(data).subscribe((res: { data: any }) => {
      this.routedata = res.data;
    });
  }

  operatordata() {
    this.ds.operatordata().subscribe((res: { data: any }) => {
      this.oprdata = res.data;
    });
  }

  ticketstaticsdata() {
    this.ds.ticketstaticsdata().subscribe((res: { data: any }) => {
  ...
  bookingbydevicedata() {
    this.ds.bookingbydevicedata().subscribe((res: { data: any }) => {
  ...
  pnrstaticsdata(range: any) {
    ...
    setTimeout(() => {
      this.ds.pnrstaticsdata(data).subscribe((res: { data: any }) => {
